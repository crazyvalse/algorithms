 ...
 * *** 有两种情况，竖着比 和横着比
 *
 * *** 横着比，只能是 遇到小的 向前追溯，因此，栈中存放递增序列
 * 遇到小的值时，开始处理，开始向前追溯，直到比当前值大，当前值小的话可以放心向前追溯
 *
 * 有两种值 大 和 小
 * 遇到小的时候，需要向前追溯
 * 遇到大值 缓存
